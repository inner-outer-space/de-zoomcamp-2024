...
<br>
MACRO USAGE 
- call the macro within double curly brackets with the parameter
- it will be replaced by the code generated by the macro with the parameter
- this example would be useful in the case where you are aggregating payment data from multiple sources that use different naming conventions for payment types.
